...
/**
 * @author ：Hyman
 * @date ：Created in 2020/6/8 17:08
 * @description：
 * @modified By：
 * @version: $
 */
public class TimeUtil {
    ...
    public static Boolean sameDay(Long sorce, Long target) {
        LocalDateTime sorcedateTime = LocalDateTime.ofEpochSecond(sorce / 1000, 0, ZoneOffset.ofHours(8));
        LocalDateTime targetdateTime = LocalDateTime.ofEpochSecond(target / 1000, 0, ZoneOffset.ofHours(8));
        return sorcedateTime.getDayOfYear() == targetdateTime.getDayOfYear();
    }

    public static Integer betweenDays(Long sorce, Long target) {
        LocalDateTime sorcedateTime = LocalDateTime.ofEpochSecond(sorce / 1000, 0, ZoneOffset.ofHours(8));
        LocalDateTime targetdateTime = LocalDateTime.ofEpochSecond(target / 1000, 0, ZoneOffset.ofHours(8));
        Integer i = targetdateTime.getDayOfYear() - sorcedateTime.getDayOfYear();
        return i;
    }
